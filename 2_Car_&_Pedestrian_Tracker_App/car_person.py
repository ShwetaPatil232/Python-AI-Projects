...
# webcam = cv2.VideoCapture('v13.mp4')
webcam = cv2.VideoCapture('v13.mp4')

# 2 -> Create Car Classifier by Using Pre-trained Car & pedestrain Classifier.
...
while True:
    ...
    if read_successful:
        ...
        # 4 -> Detect Car's & Pedestrain Coordinates.
        ...
        for(x,y,w,h) in people_coordinates: #for peoples on the road
            cv2.rectangle(frame, (x,y), (x+w, y+h), (255,0,0),3)
        for(x,y,w,h) in car_coordinates:  #for car 
